...
public final class BuilderException extends RuntimeException implements DetailedValidationFailure {
    private final List<ValidationProblem> problems;

    public BuilderException(String message) {
        super(message);
        problems = List.of(ValidationProblemCatalog.problem(message, "build"));
    }
    ...
    public BuilderException(List<ValidationProblem> problems) {
        super(firstCode(problems));
        if (problems == null || problems.isEmpty()) {
            throw new IllegalArgumentException("Builder problems cannot be empty");
        }
