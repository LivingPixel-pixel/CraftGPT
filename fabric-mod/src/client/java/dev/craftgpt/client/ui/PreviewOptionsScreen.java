...
final class PreviewOptionsScreen extends FocusedScreen {
    ...
    @Override protected void init(){
        action("craftgpt.ui.display",58,1,0,b->ClientPlatform.setScreen(minecraft, new ActionMenuScreen(this,
            "craftgpt.ui.display","craftgpt.ui.display_hint",List.of(
                ...
                of("craftgpt.ui.inspect",()->c.activeBuild().isPresent()&&!c.requestInFlight(),s->ClientPlatform.setScreen(minecraft, new BuildInspectionScreen(s,c)))))));
        action("craftgpt.ui.improve",86,1,0,b->ClientPlatform.setScreen(minecraft, new ActionMenuScreen(this,
            "craftgpt.ui.improve","craftgpt.ui.improve_hint",List.of(
                of("craftgpt.part.title",c::canVisualReview,s->ClientPlatform.setScreen(minecraft, new PartImprovementScreen(s,c))),
                ...
                of("craftgpt.findings.title",()->true,s->ClientPlatform.setScreen(minecraft, new ReviewFindingsScreen(s,c))),
                of("craftgpt.build.regenerate",()->editable()&&c.currentPlanMatchesContext(),s->UiMenus.confirm(s,
                    "craftgpt.build.regenerate","craftgpt.ui.api_charge",()->{c.compilePreview(minecraft);ClientPlatform.setScreen(minecraft, parent);}))))));
        action("craftgpt.ui.history",114,1,0,b->ClientPlatform.setScreen(minecraft, new ActionMenuScreen(this,
            "craftgpt.ui.history","craftgpt.ui.history_hint",List.of(
                ...
                of("craftgpt.preview.abandon",this::editable,s->UiMenus.confirm(s,"craftgpt.preview.abandon",
                    "craftgpt.ui.discard_hint",()->{if(editable()&&c.abandonPreview()){parent.onBuildUpdated();ClientPlatform.setScreen(minecraft, parent);}}))))));
        action("craftgpt.ui.activity",142,1,0,b->ClientPlatform.setScreen(minecraft, new ActionMenuScreen(this,
            "craftgpt.ui.activity","craftgpt.ui.activity_hint",List.of(
                ...
                of("craftgpt.ui.diagnostics",()->true,s->ClientPlatform.setScreen(minecraft, UiMenus.activity(s,c)))))));
