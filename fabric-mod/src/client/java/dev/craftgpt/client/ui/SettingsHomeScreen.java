...
class SettingsHomeScreen extends FocusedScreen {
    ...
    @Override protected void init(){
        action("craftgpt.settings.codex",68,1,0,b->ClientPlatform.setScreen(minecraft, new CodexSettingsScreen(this,config)));
        action("craftgpt.ui.api_settings",100,1,0,b->ClientPlatform.setScreen(minecraft, new AdvancedSettingsScreen(this,config,0)));
        action("craftgpt.ui.world_settings",132,1,0,b->ClientPlatform.setScreen(minecraft, new AdvancedSettingsScreen(this,config,2)));
