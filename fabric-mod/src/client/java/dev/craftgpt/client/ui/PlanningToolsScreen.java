...
final class PlanningToolsScreen extends FocusedScreen {
    ...
    @Override protected void init(){
        action("craftgpt.settings.codex",58,1,0,b->minecraft.setScreen(
            new CodexSettingsScreen(this,dev.craftgpt.client.CraftGptClient.config())));
        action("craftgpt.ui.plan_tools",86,1,0,b->minecraft.setScreen(new ActionMenuScreen(this,
            "craftgpt.ui.plan_tools","craftgpt.ui.api_hint",List.of(
                ...
                of("craftgpt.ui.details",()->true,s->minecraft.setScreen(new StatusDetailsScreen(s,parent::details)))))));
        action("craftgpt.ui.exchange",114,1,0,b->minecraft.setScreen(new ActionMenuScreen(this,
            "craftgpt.ui.exchange","craftgpt.ui.exchange_hint",List.of(
                of("craftgpt.portable.import",()->!c.requestInFlight()&&c.currentContext().isPresent(),s->{minecraft.setScreen(parent);c.importPortable(minecraft);}),
        ...
        action("craftgpt.ui.activity",142,1,0,b->minecraft.setScreen(new ActionMenuScreen(this,
            "craftgpt.ui.activity","craftgpt.ui.activity_hint",List.of(
                of("craftgpt.book.primary.codex_progress",()->true,s->minecraft.setScreen(new CodexGenerationScreen(s,c))),
